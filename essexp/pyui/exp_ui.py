...
"}")
        ...
        sizePolicy.setHeightForWidth(self.bt_minimize.sizePolicy().hasHeightForWidth())
        self.bt_minimize.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.fileTreeView.sizePolicy().hasHeightForWidth())
        self.fileTreeView.setSizePolicy(sizePolicy1)
    ...
    def retranslateUi(self, exp):
        exp.setWindowTitle(QCoreApplication.translate("exp", u"MainWindow", None))
